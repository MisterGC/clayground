...
Item {
    ...
    readonly property var rows: [
        ...
        { label: "triangles (filled)",   color: "#ffd93d", style: { dash: [8, 30], pattern: "triangle" } },
        { label: "triangles + flow",     color: "#ffd93d", style: { dash: [8, 30], pattern: "triangle", flow: 70 } },
        { label: "triangles narrow",     color: "#ffd93d", style: { dash: [8, 30], pattern: "triangle", glyphWidth: 0.6 } },
