...
section('directives: emotion')
{
    ...
    eq('disgust', shape('*disgust*'), 'emotion disgust')
    eq('surprised', shape('*surprised*'), 'emotion surprised')
    eq('alias disgusted', cues('*disgusted*')[0].value, 'disgust')
    eq('alias surprise', cues('*surprise*')[0].value, 'surprised')
    eq('alias shocked', cues('*shocked*')[0].value, 'surprised')
