    ...
    */
    ...
    readonly property var _kernel: ({
        "en": {
            ...
            "keys.mode": "build / explore / measure",
            "keys.explore": "explore while held",
            "keys.unmeasure": "undo the last point · Esc clears",
            "mode.build": "build",
            "mode.explore": "explore",
            "mode.measure": "measure",
            "mode.hint.build": "left and right button build · middle drag or Space moves the view · wheel zooms",
            "mode.hint.explore": "drag moves the world · right-drag turns it around the cursor · wheel zooms",
            "mode.hint.measure": "click sets a measuring point · drag moves the world · ⌫ undoes · Esc clears",
        ...
        "de": {
            ...
            "keys.mode": "bauen / erkunden / messen",
            "keys.explore": "halten: erkunden",
            "keys.unmeasure": "letzten Punkt zurück · Esc löscht",
            "mode.build": "bauen",
            "mode.explore": "erkunden",
            "mode.measure": "messen",
            "mode.hint.build": "linke und rechte Taste bauen · mittlere Taste oder Leertaste bewegt die Ansicht · Rad zoomt",
            "mode.hint.explore": "ziehen bewegt die Welt · rechte Taste dreht sie um den Zeiger · Rad zoomt",
            "mode.hint.measure": "Klick setzt einen Messpunkt · ziehen bewegt die Welt · ⌫ zurück · Esc löscht",
