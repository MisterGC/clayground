    ...
    */
    ...
    readonly property var _kernel: ({
        "en": {
            ...
            "keys.mode": "build on / off",
            "keys.nav": "move the view while held",
            ...
            "mode.hint.use": "drag moves the world · right-drag turns it around the cursor · wheel zooms",
            "mode.hint.hand": "click measures · drag still moves the world · ⌫ undoes · P keeps it · Esc clears",
        ...
        "de": {
            ...
            "keys.mode": "bauen an / aus",
            "keys.nav": "halten: Ansicht bewegen",
            ...
            "mode.hint.use": "ziehen bewegt die Welt · rechte Taste dreht sie um den Zeiger · Rad zoomt",
            "mode.hint.hand": "Klick misst · ziehen bewegt weiterhin die Welt · ⌫ zurück · P behält · Esc löscht",
