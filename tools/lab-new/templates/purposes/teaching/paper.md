# {{Title}} — one line saying what this lab teaches

*Companion paper to the interactive lab in `labs/{{slug}}/`. Overview
board: `overview.grafli`. Purpose: **{{purpose}}** — this is a lesson
plan, and the guided flow is the primary artifact; this paper is its
script. Started {{date}}. Annotate freely with CriticMarkup.*
